...
let GetCategoryUseCase = class GetCategoryUseCase {
    categoryRepository;
    ...
    async getAllCategoriesAndCharges() {
        try {
            const result = await this.categoryRepository.getCategories();
            return result;
        }
...
GetCategoryUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [category_repository_1.CategoryRepository])
], GetCategoryUseCase);
exports.default = GetCategoryUseCase;
//# sourceMappingURL=get-category.usecase.js.map