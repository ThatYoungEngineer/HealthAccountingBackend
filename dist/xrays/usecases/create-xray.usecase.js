...
let CreateXrayUseCase = class CreateXrayUseCase {
    xrayRepository;
    constructor(xrayRepository) {
        this.xrayRepository = xrayRepository;
    }
    async createXray(createXrayDto) {
        try {
...
CreateXrayUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [xray_repository_1.XrayRepository])
], CreateXrayUseCase);
exports.default = CreateXrayUseCase;
//# sourceMappingURL=create-xray.usecase.js.map